# Hi there 👋, I'm Aly Fawzy Mohamed
...
- 🏗️ Strong background in Clean Architecture, MVVM, MVC, and VIPER
- ⚡ Experienced in performance optimization and memory management
- 🔄 Built CI/CD pipelines using GitHub CI, TeamCity, CircleCI, Firebase Distribution, and TestFlight
- 🌍 Worked with international teams across the Middle East and Europe
...
- Built real-time communication using Agora and Pusher
